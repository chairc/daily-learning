...
def load_data_fashion_mnist(batch_size, resize=None):
    ...
    mnist_train = torchvision.datasets.FashionMNIST(root="C:/Users/lenovo/Desktop/Testing environment/pytorch learning/Datasets/FashionMNIST",
                                                    train=True,
                                                    transform=trans,
                                                    download=True)
    mnist_test = torchvision.datasets.FashionMNIST(root="C:/Users/lenovo/Desktop/Testing environment/pytorch learning/Datasets/FashionMNIST",
                                                   train=False,
                                                   transform=trans,
                                                   download=True)
